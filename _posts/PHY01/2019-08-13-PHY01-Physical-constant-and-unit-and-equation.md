...
|Quantum System|<span class='jb-small'>$$i\hbar \frac { \partial  }{ \partial t }\mid\Psi \rangle=\hat { H }\mid\Psi \rangle $$</span><br><span class='jb-small'>$$i\hbar \gamma ^{ \mu  }\partial _{ \mu  }\mid\Psi \rangle-mc\mid\Psi \rangle=0 $$</span>|
|Statistical and Thermal Physics|<span class='jb-small'>$$\Delta U=\sum { T } $$</span><br><span class='jb-small'>$$dS\ge 0 $$</span>|
