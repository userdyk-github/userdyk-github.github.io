...
|Electrical inductance|<span class='jb-x-small'>$$H$$</span>|<span class='jb-x-small frame2'>$$\epsilon =-L\frac { dI }{ dt } $$</span> / <span class='jb-x-small frame2'>$$\epsilon =V $$</span> / <span class='jb-x-small frame2'>$$\Delta V=-\int { \overrightarrow { E }\cdot d\overrightarrow { s } } $$</span> / <span class='jb-x-small frame2'>$$\oint _{ C }{ \overrightarrow { E }\cdot d\overrightarrow { l } }=-\frac { d }{ dt }\int _{ S }{ \overrightarrow { B }\cdot d\overrightarrow { a } } $$</span><br><span class='jb-x-small'>$$1 H = 1V * 1s/1A = 1Wb/1A$$</span>|
