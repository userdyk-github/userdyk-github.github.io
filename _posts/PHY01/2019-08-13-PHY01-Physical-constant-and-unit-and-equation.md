...
|Angle|<span class='jb-x-small'>$$rad$$</span>|<span class='jb-x-small frame2'>$$\theta =\frac { r }{ l } $$</span><br><span class='jb-x-small'>$$1rad\ means\ the\ center\ angle\ of\ a\ arc\ whose\ radius\ (r)\ is\ equal\ to\ one\ circle\ and\ whose\ arc\ length\ (l)\ is equal\ to\ one.$$</span>  |
|Solid angle|<span class='jb-x-small'>$$sr$$</span>|<span class='jb-x-small frame2'>$$\Omega =\frac { A }{ r^{ 2 } } $$</span><br><span class='jb-x-small'>$$1sr\ means\ a\ three-dimensional\ angle\ of\ the\ horn\ in\ which\ the\ width\ (A)\ of\ the\ shape\ above\ the\ sphere\ is\ equal\ to\ one\ for\ a\ sphere\ with\ a\ radius\ (r).$$</span>|
