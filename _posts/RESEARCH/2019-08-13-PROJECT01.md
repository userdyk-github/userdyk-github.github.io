...
- [Extractraction][2] of simple graphical entities from SVG images in PDF for chart classification
- [Web crawler][3] that collects and classifies SVG images using image elements
