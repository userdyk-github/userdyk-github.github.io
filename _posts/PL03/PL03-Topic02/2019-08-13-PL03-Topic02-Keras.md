...
model.fit(train_data, labels, batch_size=32, epochs=3)
```
<details markdown="1">
...
```
Epoch 1/3
1000/1000 [==============================] - 1s 1ms/step - loss: 0.6940 - acc: 0.5100
Epoch 2/3
1000/1000 [==============================] - 0s 50us/step - loss: 0.6939 - acc: 0.5100
Epoch 3/3
1000/1000 [==============================] - 0s 44us/step - loss: 0.6938 - acc: 0.5100
```
<hr class='division3'>
</details>
<details markdown="1">
...
<hr class='division3'>
```python
results = model.evaluate(train_data, labels)
for i in range(len(model.metrics_names)):
    print(model.metrics_names[i]," : ", results[i])
```
`OUTPUT`
```
1000/1000 [==============================] - 1s 539us/step
loss  :  0.6937304649353028
acc  :  0.51
```
<hr class='division3'>
</details>
