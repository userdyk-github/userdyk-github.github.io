...
<p class="frame1" style="font-size: 70%;">first user log in run level #3<br>
<ul>
  <li>/etc/profile</li>
  <li>~/.profile</li>
</ul>
...
<p class="frame1" style="font-size: 70%;">virtual terminal run<br>
<ul>
...
<br><br>
#### logout script
<p class="frame1" style="font-size: 70%;">
<ul>
  <li>~/.bash_logout</li>
</ul>
</p>
