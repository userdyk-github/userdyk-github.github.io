...
```bash
$ docker run --gpus all -it --rm -v local_dir:container_dir nvcr.io/nvidia/pytorch:20.03-py3
```
<br><br><br>
...
```bash
$ docker run --gpus all -p [port1]:8000 -p [port2]:6006 -d --name jupyterhub jupyterhub/jupyterhub jupyterhub
