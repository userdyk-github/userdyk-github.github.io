...
### ***Display manager***
<a href="https://askubuntu.com/questions/53822/how-do-you-run-ubuntu-server-with-a-gui" target="_blank">apt</a>
```bash
$ apt update
$ apt install ubuntu-desktop
$ apt purge ubuntu-desktop -y && sudo apt autoremove -y && sudo apt autoclean
```
<a href="https://linuxconfig.org/install-gui-on-ubuntu-server-18-04-bionic-beaver" target="_blank">tasksel</a>
```bash
$ apt update
$ apt install tasksel
$ tasksel install
