...
$ sudo add-apt-repository [repository_name]             #  add repository on sources.list
$ sudo add-apt-repository --remove [repository_name]    #  remove repository on sources.list
