...
### ***cygwin***
#### dowonload
<a href='https://www.cygwin.com/' target="_blank">cygwin download</a>｜<a href="https://github.com/transcode-open/apt-cyg" target="_blank">apt-cyg github</a><br>
```bash
# wget, tmux, vim, python, pip
