...
<a href="https://sosobaba.tistory.com/193" target="_blank">URL</a><br>

```dos
setx path "%PATH%;[path]"        # all env-variable
setx UserPath "[path]"           # user env-variable
setx SystemPath "[path]" -m      # system env-variable
```
<br><br><br>
