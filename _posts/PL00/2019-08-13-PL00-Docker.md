...
<span class="frame3">Display Docker Hosts Associated with the Running Attached Docker Engine</span>
```bash
$ snap install docker
$ docker-machine ls    # Display Docker Hosts Associated with the Running Attached Docker Engine
```
...
<span>Display Local Docker Images</span><br>
```bash
$ docker images
```
<br><br><br>
