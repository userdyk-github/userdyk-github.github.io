...
I will introduce data fitting techniques. The goal is to answer which graph are best suited to this data when given, as shown in the figure on the left. _As a result, if you run the below following **main code**, you can get the above graph on the right._
