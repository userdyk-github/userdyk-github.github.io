...
I will introduce data fitting techniques. The goal is to answer which graph are best suited to this data when given, as shown in the figure on the left. As a result, if you run the below following **main code**, you can get the graph above, on the right.
